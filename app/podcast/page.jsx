...
import { Play, Pause, SkipBack, SkipForward, Mic, Clock, Calendar, Loader2, AlertCircle, ChevronDown, Square } from 'lucide-react';

// --- Page Specific SEO ---
// Note: In Next.js App Router, metadata must be exported from a Server Component.
// Since this is a 'use client' component, we usually separate the metadata into a layout.js
// or keep this logic if we were using a server wrapper.
// However, for this single-file structure in preview, we assume the framework handles it
// or you would move 'export const metadata' to a separate 'layout.js' for this route in a real app.
// For now, I will keep the component logic focused on functionality as requested previously
// but in a real Next.js app, put 'export const metadata' in a layout.js file in this folder.
...
export default function PodcastPage() {
    ...
    const playEpisode = (ep) => {
        ...
        setIsPlaying(true);
        setProgress(0);
        // Expand mobile player when clicking a new episode
    ...
    return (
        <div className="bg-gray-900 text-white min-h-screen pt-32 pb-48 lg:pb-24">
            {/* NOTE FOR SEO:
        In a real Next.js app, ensure 'app/podcast/layout.js' contains:
        export const metadata = {
          title: 'Podcast | Life Reach Church',
          description: 'Listen to weekly sermons and conversations from Life Reach Church on faith, culture, and leadership.',
          openGraph: {
            images: ['https://images.unsplash.com/photo-1478737270239-2f02b77ac618?auto=format&fit=crop&q=80&w=1200']
          }
        };
      */}
              ...
              `}
               ...
               `}>
                  ...
                  `}>
                        ...
                        {/* Description Box (Visible on Desktop OR Mobile Full) */}
                        <div className={`
                  mt-12
