                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-16 items-center mb-32">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                        >
                            <h3 className="text-orange-600 font-bold uppercase tracking-widest mb-2">Since 2013</h3>
                            ...
                            <div className="flex gap-4">
                                <div className="text-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100 w-32">
                                    <div className="text-3xl font-black text-orange-600 mb-1">10+</div>
                        ...
                        <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gray-900">
                            <div className="grid md:grid-cols-2">
                                ...
                                <div className="p-12 md:p-20 flex flex-col justify-center text-white">
                                    <h3 className="text-orange-500 font-bold uppercase tracking-widest mb-2">Lead Pastor</h3>
                                    <h2 className="text-4xl md:text-5xl font-black mb-6">Michael Ford</h2>
                                    <p className="text-gray-300 text-lg leading-relaxed mb-6">
                                        Pastor Michael has a heart to see people set free and walking in their God-given purpose. With over 20 years of ministry experience, he communicates the Bible in a way that is practical, humorous, and life-changing.
                                    </p>
                                    <p className="text-gray-300 text-lg leading-relaxed mb-8">
                                        He and his wife, Sarah, founded Life Reach Church in 2013. They have three children and love coffee, hiking, and the local sports team.
                                    </p>
                                    <div className="flex gap-4">
