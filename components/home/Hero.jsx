...
export default function Hero() {
    ...
    const [hasLiveStream, setHasLiveStream] =
        useState(false);
    ...
    const [heroImage, setHeroImage] =
        useState("/imgs/SHIFT2025-212.jpg");
        ...
        const fetchHeroContent = async () => {
            ...
            try {
                ...
                const res = await axios.get(
                    `${API_URL}/hero/get_hero_content.php`
                );
                ...
                console.log(
                    "Using default hero content and background"
                );
    ...
    useEffect(() => {
        ...
        const checkLiveStream = async () => {
            ...
            try {
                ...
                const res = await axios.get(
                    `${API_URL}/streams/get_active.php`
                );
                ...
                console.error(
                    "Failed to verify active live stream:",
                    error
                );
            ...
            <div className="relative z-10 px-6 max-w-5xl mx-auto mt-16">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center">
                        ...
                        {/* ONLY SHOW LIVE BUTTON IF STREAM EXISTS */}
                        ...
                        <a href={heroContent.button2_link}>
